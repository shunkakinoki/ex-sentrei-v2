    ...
    <div className="flex flex-col w-full md:flex md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex mt-5 md:mt-0 md:ml-4">
        <span className="rounded-md shadow-sm ">
          <button
            type="button"
            className="inline-flex items-center px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-500 focus:outline-none focus:shadow-outline-pink focus:border-pink-300 active:text-gray-800 active:bg-gray-50"
          >
            <svg
