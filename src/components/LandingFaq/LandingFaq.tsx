        ...
        <div className="grid grid-cols-1 gap-0 text-gray-700 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <p className="text-base leading-6 text-gray-500">
              Sentrei is a writing platform that devotes itself to being not
              evil, being fair to both readers and writers.
            </p>
            <h5 className="mt-10 mb-3 font-semibold text-gray-900">
            ...
            <p className="text-base leading-6 text-gray-500">
              Technically, yes. We use Stripe to process payments, so Stripe
              will have a 3.6% commission fee on paywalls. However, unlike many
              publishing platforms, the rest will belong to you, as Sentrei
              takes no platform commissions.
            </p>
            <h5 className="mt-10 mb-3 font-semibold text-gray-900">
              Is there a discount for Startups and Colleges?
            </h5>
            <p className="text-base leading-6 text-gray-500">
              Yes. We are a small startup too, and we would love to be with you
              on this journey. There is a $10/month plan for startups and
              educational institutions. Please contact{" "}
              <Link href="/support">
          ...
          <div>
            ...
            <p className="text-base leading-6 text-gray-500">
              ...
              that gets in the way of a great reading experience. We believe
              that the internet deserves much more than what is the status as of
              now in 2020.
            </p>
            <h5 className="mt-10 mb-3 font-semibold text-gray-900">
            ...
            <p className="text-base leading-6 text-gray-500">
              It will be a sad day for our team, and we would do whatever it
              takes to make you our happiest customer. But if you still insist,
              you can.
            </p>
            <h5 className="mt-10 mb-3 font-semibold text-gray-900">
            ...
            <p className="text-base leading-6 text-gray-500">
              Yes. The billing happens every month automagically. You will
              receive a renewal notice three days before the actual renewal
              happens.
            </p>
            <h5 className="mt-10 mb-3 font-semibold text-gray-900">
