export default function LandingDemo(): JSX.Element {
  return (
    <section className="container max-w-screen-xl px-3 py-3 mx-auto">
      ...
      <div className="container justify-center flex-grow max-w-screen-xl mx-auto transition duration-300 ease-in-out transform rounded-lg shadow-2xl hover:-translate-y-3">
